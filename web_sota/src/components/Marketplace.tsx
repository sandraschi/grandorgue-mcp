import { Download, Globe, Music, Search } from "lucide-react";
    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      {loading ? (
        ...
        <>
          ...
          {installed.length > 0 && (
            <section>
              <h2 className="text-sm text-zinc-400 mb-3 flex items-center gap-2">
                <Music size={14} /> Installed ({installed.length})
              </h2>
          ...
          <section>
            <h2 className="text-sm text-zinc-400 mb-3 flex items-center gap-2">
              <Globe size={14} /> Available Sample Sets (
              {filtered.filter((f) => !f.installed).length})
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
              {filtered
          ...
          <section className="bg-zinc-900 rounded-lg p-4 border border-zinc-800">
            ...
            <p className="text-xs text-zinc-500 mb-3">
              ...
              — BWV 525-771, including Preludes & Fugues, Toccatas, Trio Sonatas, Orgelbuchlein,
              Schubler Chorales, and the Great Eighteen.
            </p>
            <div className="flex flex-wrap gap-2">
              {[
                ...
                <span
                  key={cat}
                  className="px-2 py-0.5 text-[10px] bg-zinc-800 text-zinc-400 rounded-full"
                >
                  {cat}
                </span>
              ))}
              ...
              {[
                {
                  ...
                  desc: "Largest classical MIDI archive",
                },
                {
                  name: "Classical Archives",
                  url: "https://www.classicalarchives.com/midi/",
                  desc: "Curated MIDI collection",
                },
                {
                  name: "Mutopia Project",
                  url: "https://www.mutopiaproject.org/",
                  desc: "Free sheet music + MIDI",
                },
              ].map((src) => (
                <a
                  key={src.name}
  ...
  return (
    <div className="bg-zinc-900 rounded-lg p-4 border border-zinc-800 hover:border-organ-gold/30 transition-colors">
      <div className="flex items-start justify-between gap-2">
        ...
        {organ.installed ? (
          <span className="shrink-0 px-2 py-0.5 text-[10px] bg-green-900 text-green-300 rounded-full">
            Installed
          </span>
        ) : (
          <span className="shrink-0 px-2 py-0.5 text-[10px] bg-organ-gold/20 text-organ-gold rounded-full">
            Free
          </span>
        )}
      </div>
  ...
  return [
    {
      name: "Caen Abbey",
      path: "",
      url: "https://piotrgrabowski.pl/caen/",
      description:
        "French Romantic organ — the most famous free sample set. 4 manuals, 54 stops, magnificent Cavaille-Coll sound.",
      manuals: 4,
      stops: 54,
      is_free: true,
      installed: false,
      ...
      creator: "Piotr Grabowski",
    },
    {
      name: "Friesach",
      path: "",
      url: "https://piotrgrabowski.pl/friesach/",
      description:
        "Austrian Baroque organ with crisp plenum. Excellent for Bach and North German repertoire.",
      manuals: 3,
      stops: 34,
      is_free: true,
      installed: false,
    ...
    },
    {
      name: "Giubiasco",
      path: "",
      url: "https://piotrgrabowski.pl/giubiasco/",
      description:
        "Italian Baroque organ in the South German style. Bright, clear principals and flutes.",
      manuals: 2,
      stops: 25,
      is_free: true,
      installed: false,
    ...
    },
    {
      name: "Palma",
      path: "",
      url: "https://piotrgrabowski.pl/palma/",
      description:
        "Spanish Baroque organ with characteristic horizontal reeds (trompeteria). 4 manuals.",
      manuals: 4,
      stops: 52,
      is_free: true,
      installed: false,
    ...
    },
    {
      name: "St. Omer",
      path: "",
      url: "https://piotrgrabowski.pl/st-omer/",
      description:
        "French Classical organ — authentic 18th-century French registration for Couperin and de Grigny.",
      manuals: 4,
      stops: 48,
      is_free: true,
      installed: false,
    ...
    },
    {
      name: "Cracov",
      path: "",
      url: "https://piotrgrabowski.pl/cracov/",
      description: "Polish Romantic organ. Warm foundation stops and a beautiful Oboe solo.",
      manuals: 2,
      stops: 31,
      is_free: true,
      installed: false,
      size_hint: "~2.5 GB",
      style: "Polish Romantic",
      creator: "Piotr Grabowski",
    },
    {
      name: "Burea Church",
      ...
      description:
        "Swedish Romantic church organ. Warm, intimate sound perfect for service playing.",
      manuals: 2,
      stops: 20,
      is_free: true,
      installed: false,
      size_hint: "~2 GB",
      style: "Swedish Romantic",
      creator: "Lars Palo",
    },
    {
      name: "Pitea MHS",
      ...
      description: "Swedish school organ — bright, clear, ideal for Bach and teaching.",
      manuals: 2,
      stops: 12,
      is_free: true,
      installed: false,
    ...
    },
    {
      name: "Melcer Chamber",
      path: "",
      url: "https://piotrgrabowski.pl/melcer/",
      description:
        "Small Polish chamber organ. Intimate and manageable — perfect for home practice.",
      manuals: 2,
      stops: 12,
      is_free: true,
      installed: false,
      size_hint: "~1 GB",
      style: "Polish Chamber",
      creator: "Piotr Grabowski",
    },
    ...base.filter(
      (b) =>
        !["Piotr Grabowski", "Lars Palo", "Burea Church", "Pitea MHS", "Demo Organ"].includes(
          b.name,
        ),
    ),
  ];
